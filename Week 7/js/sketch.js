...
function preload()
{
    ...
    backgoundimage = loadImage("../images/asciiartimages/clouds.jpg")
...
function draw()
{
    ...
    if(keyIsPressed)
    {
        ...
        if (key == 'd') {
            ...
            if (myWalkAnimation.isCircleColliding(GumDrop[0])) {
                //console.log("ouch")
            }
   ...
   for(var i = 0; i < GumDrop.length; i++)
   {
    ...
    if(isColliding)
    {
        ...
        GumDrop[i] = new Candy (random(20, 950),random(20, 950),random(20,50));
   }
   }
